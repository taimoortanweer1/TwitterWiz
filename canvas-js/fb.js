  ...
  //  Initialize Facebook Javascript SDK
{
  ...
  $.getScript( "//connect.facebook.net/en_US/all.js", function() {
    FB.init(
      { appId: '216418078561602', status: true, cookie: true, oauth: true }
    );
  } );
  ...
  $("#fb-btn").click( function() {	// Click handler for FB button
    ...
    if ( resp != null ) {		// Connected and authorized?
      FB.logout( function( resp ) {
        $("#fb-btn").hide();
        console.log( "Facebook logout" );
      } );

    } else {				// Not connected/authorized
      $("#fb-btn").hide();		// Ensure logout button hidden
      console.log( "Facebook button click w/o login/authorization" );
    }
  } );
