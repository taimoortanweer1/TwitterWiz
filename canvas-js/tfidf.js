...
function choose_rep_term( c, tw_ID, tw_n )

  //  Choose "top" representative terms for the given cluster
  //
  //  c:      Cluster to examine
  ...
  //  tw_n:   Number of terms
{
  ...
  term_wt = { };			// Initialize term weight list
  ...
  C_term[ c ] = term_sort[ 0 ].key;	// First term in term list
  ...
  //  previous term, stop adding terms, to a max of 5 terms
    ...
    C_term[ c ] = C_term[ c ] + "," + term_sort[ i ].key;
  }
