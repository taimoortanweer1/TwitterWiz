  ...
  //  to include those tweets
{
  ...
  msg = "Sentiment estimated on " + tw.length + " tweets";
  exp = "A total of " + URL_line.length + " tweets were read. Of those, "
  exp = exp + tw.length + " tweets had two or more recognized terms, "
  exp = exp + "allowing for an estimate of their sentiment.";
